...
export default function CreateSessionModal({ open, eventId, onClose, onCreated }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const created = await eventSessionsService.create({
